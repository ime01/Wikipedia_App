...
import wikipedia.activities.allClasses.models.WikiThumbnail
import java.sql.RowId

class FavoriteRepository (val databaseHelper: ArticleDataBaseOpenHelper ){
